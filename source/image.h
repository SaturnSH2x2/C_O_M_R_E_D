...
namespace img {
    ...
    void draw_lower_screen_img(sf2d_texture *image, float loc_x, float loc_y, float scale) {
        sf2d_draw_texture_part_scale(image, -40.0F, 0.0F, loc_x, loc_y + scale + screen_gap, scale, scale * (5.0 * 3.0), 400.0 / scale, 240.0 / scale);
    }
    
    void draw_upper_screen_img_rot(sf2d_texture *image, float loc_x, float loc_y, float scale, float rot) {
        sf2d_draw_texture_part_rotate_scale(image, 200, 120, rot, loc_x, loc_y, scale, scale * (5.0 / 3.0), 400.0 / scale, 240.0 / scale);
    }
    
    void draw_lower_screen_img_rot_r(sf2d_texture *image, float loc_x, float loc_y, float scale) {
        sf2d_draw_texture_part_rotate_scale(image, 160, 120, M_PI / 2.0, loc_x + scale + screen_gap, loc_y, scale, scale * (5.0 / 3.0), 400.0 / scale, 240.0 / scale);        
    }
    
    void draw_lower_screen_img_rot_l(sf2d_texture *image, float loc_x, float loc_y, float scale) {
        sf2d_draw_texture_part_rotate_scale(image, 160, 120, (3.0 * M_PI) / 2.0, loc_x - scale - screen_gap, loc_y, scale, scale * (5.0 / 3.0), 400.0 / scale, 240.0 / scale);           
    }
   ...
   void draw_screens_os(sf2d_texture *img, float loc_x, float loc_y, float scale, btn::Button *b1, btn::Button *b2, btn::Button*b3, btn::Button *b4, btn::Button *b5, btn::Button *b6, bool is_2DS) {
       if (is_2DS) {
           screen_gap = 20;
       } else {
           screen_gap = 40;
   ...
   void draw_screens_ts (sf2d_texture *img, float loc_x, float loc_y, float scale, btn::Button *b1, btn::Button *b2, btn::Button *b3, btn::Button *b4, btn::Button *b5, btn::Button *b6, bool is_2DS) {
       if (is_2DS) {
           screen_gap = 20;
       } else {
           screen_gap = 40;
   ...
   void draw_screens_tsr (sf2d_texture *img, float loc_x, float loc_y, float scale, btn::Button *b1, btn::Button *b2, btn::Button *b3, btn::Button *b4, btn::Button *b5, btn::Button *b6, bool is_2DS) {
       if (is_2DS) {
           screen_gap = 20;
       } else {
           screen_gap = 40;
   ...
   void draw_screens_tsl(sf2d_texture *img, float loc_x, float loc_y, float scale, btn::Button *b1, btn::Button *b2, btn::Button *b3, btn::Button *b4, btn::Button *b5, btn::Button *b6, bool is_2DS) {
       if (is_2DS) {
           screen_gap = 20;
       } else {
           screen_gap = 40;
